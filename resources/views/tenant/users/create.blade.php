    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 mt-1">Create a new user account for your organization</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('tenant.users.store') }}" enctype="multipart/form-data" class="p-6">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Optional. JPG, PNG, WEBP up to 5MB.</p>
                        @error('photo')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
