...
function initializeStatusChart() {
    fetch('{{ route("tenant.reports.submissions-by-status") }}')
...
function initializeTrendChart() {
    fetch('{{ route("tenant.reports.submissions-over-time") }}')
        .then(response => response.json())
        .then(data => {
...
function initializeFormChart() {
    fetch('{{ route("tenant.reports.form-analytics") }}')
        .then(response => response.json())
        .then(data => {
...
document.getElementById('report-builder-form').addEventListener('submit', function(e) {
    ...
    fetch(`{{ route("tenant.reports.generate") }}?${params}`)
        .then(response => response.json())
        .then(data => {
