    ...
    function generateInteractiveField(fieldType, config) {
        ...
        switch (fieldType) {
            ...
            case 'gps':
                ...
                break;
            case 'barcode':
                html = '<div class="space-y-2"><button type="button" class="bg-blue-500 text-white px-4 py-2 rounded text-sm">📱 Scan Barcode<\/button><input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" placeholder="Or enter code manually"' + requiredAttr + '><\/div>';
                break;
            default:
