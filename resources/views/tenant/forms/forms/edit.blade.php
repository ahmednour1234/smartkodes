        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('tenant.forms.update', $form) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-sm text-blue-700">
                                        Use the <a href="{{ route('tenant.forms.builder', $form) }}" class="font-semibold underline hover:text-blue-900">Form Builder</a> to add, edit, or rearrange fields with drag & drop.
