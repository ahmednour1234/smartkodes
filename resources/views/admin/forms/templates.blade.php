            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mb-8 p-6 bg-gray-50 rounded-lg">
                        ...
                        <form method="POST" action="{{ route('admin.forms.import-template') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    @forelse($myForms as $form)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                <a href="{{ route('admin.forms.clone', $form) }}" class="text-blue-600 hover:text-blue-900">Clone</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                                                No published forms available as templates. <a href="{{ route('admin.forms.create') }}" class="text-blue-600 hover:text-blue-900">Create one now</a>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
