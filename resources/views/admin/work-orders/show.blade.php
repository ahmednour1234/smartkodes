        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.projects.show', $workOrder->project->id) }}"
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-500 mb-2">Assigned Form Templates ({{ $workOrder->forms->count() }})</label>
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-yellow-700 mt-1">This work order has no form templates assigned yet.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('admin.records.create', ['work_order_id' => $workOrder->id]) }}"
        ...
        <div class="space-y-6">
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-yellow-700 mt-1">This work order has not been assigned to anyone yet.</p>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-2">
                    ...
                    @if($workOrder->forms->count() > 0)
                        <a href="{{ route('admin.forms.show', $workOrder->forms->first()->id) }}"
                           class="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-lg transition duration-200">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-lg font-bold text-gray-900">{{ $workOrder->records->count() }}</span>
                    </div>
