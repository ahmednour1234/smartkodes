        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-8">
                ...
                <div class="mb-8 flex justify-between items-start">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Record: {{ $record->form->name }}</h1>
                ...
                <!-- Form Fields -->
                <form id="edit-record-form" method="POST" action="{{ route('admin.records.update', $record) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
