...
return [
    ...
    'description' => 'SmartKodes API Documentation - A comprehensive API for managing forms, work orders, users, and records in a multi-tenant environment.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for authentication. You can retrieve your token by logging in via the `/api/v1/login` endpoint. Include the token in the Authorization header as: `Bearer {your-token}`.',
    ],
